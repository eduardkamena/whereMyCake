...
/**
 * Контроллер для работы с отчетами о питании пользователя.
 * Предоставляет API для получения дневного отчета, проверки дневной нормы калорий и истории питания за период.
 */
@RestController
...
public class ReportController {
     ...
     * @return История питания за период.
     */
    @Operation(
